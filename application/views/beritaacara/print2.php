...
<section class="content">
 <form action="<?=base_url('beritaacara/saveprint');?>" method="post" id="formroll" target="_blank">
    ...
    <div class="col-xs-2">
               			  ...
               			  <div class="col-xs-6">
                            <label>Masalah</label>
               				  <input name="masalah" type="text" class="form-control" id="masalah" value="<?=(isset($beritaacara->masalah))?$beritaacara->masalah:'';?>" placeholder="Masalah...."/>
                			</div>
                  ...
                  <div class="form-group">
                  <label>Alasan</label><textarea name="alasan" class="textarea" id="alasan" style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" placeholder="Message"><?=(isset($beritaacara->alasan))?$beritaacara->alasan:'';?>
                            </textarea>
                      </div>
