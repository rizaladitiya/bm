                ...
                <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <label>Kendaraan</label>
                    			<div class="input-group">
                      			<input name="kendaraan" type="text" class="form-control pull-right" id="kendaraan" value="<?=(isset($reject->kendaraan))?$reject->kendaraan:'';?>"  placeholder="Ketik Nomer Kendaraan disini....."/>
                    			</div>
                        </div>
                        </div>
                        <div class="row">
