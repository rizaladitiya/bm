...
<section class="content-header">
    <h1>
        Laporan PP<small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Gudang</li>
        <li class="active">Laporan PP</li>
    </ol>
</section>
    	...
    	<div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Harga Plan Detail</h3>
			
              
            </div>
            <!-- /.box-header -->
			<div class="box box-primary">
			<form action="<?=base_url('gudang/lappp');?>" method="post" id="formlappp">
                <div class="box-header">
                ...
                <div class="box-body">
                    <div class="form-group">
						<div class="row">
							...
							<?php  
							foreach($bagian as $detailbagian){
							?>
      							<option value=<?=$detailbagian->id; ?> <?=set_select('bagian',$detailbagian->id, ($this->session->userdata("bagian")==$detailbagian->id));?>><?=$detailbagian->nama; ?></option>
      <?php } ?>            </select>
                			</div>
						</div>
					</div>
