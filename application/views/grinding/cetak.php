...
<section class="col-xs-12 connectedSortable">
  ...
  <tr>
    ...
    <td>:&nbsp;<?=$grinding->before;?></td>
  </tr>
  <tr>
    <td>After Grinding Diameter</td>
    
    <td>:&nbsp;<?=$grinding->after;?></td>
  </tr>
  <tr>
    <td>Face Length</td>
    
    <td>:&nbsp;<?=$grinding->face_length;?></td>
  </tr>
  <tr>
    <td>Crowning &amp; Sin Curve</td>
    
    <td>:&nbsp;<?=$grinding->crowning;?></td>
  </tr>
  <tr>
...
$(function () {
		...
		if(!empty($actual)){
			...
			foreach($actual as $index => $value)
			{
				...
				$target=(float) round(0,3);
				$targetmin=(float) round(0-($range/2),3);
				$targetmax=(float) round(0+($range/2),3);
