                  ...
                  <div class="form-group">
                        ...
                        <div class="col-xs-3">
                       	  <label>Diameter After</label>
                        		<input name="after" type="text" class="form-control" id="after" value="<?php echo (isset($grinding->after))?$grinding->after:'';?>" placeholder="mm..." data-inputmask='"mask": "999.99"' data-mask/>
                        </div>
                     </div>
                  </div>
                  <div class="form-group">
